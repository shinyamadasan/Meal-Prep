...
Claude never touches app code and never invokes Codex in this loop — Codex is always started by you,
manually, saying "Continue." See `docs/09-automation.md` (enable/disable, rollback, test checklist)
and DECISIONS D-022.
