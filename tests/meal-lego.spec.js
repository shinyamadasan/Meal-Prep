...
// those dates still being fresh/expiring relative to "today" — e.g. fridgeLife 3
// on a 2026-08-24 batch means "expires 2026-08-27". Left to the real wall clock,
// the fixture silently expires once the calendar rolls past that window (it did,
// in CI, on 2026-08-28 UTC). Pinning the page clock to the fixtures' own era makes
// that relationship explicit and immune to the machine's real current date.
